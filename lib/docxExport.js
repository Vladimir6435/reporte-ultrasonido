    ...
    children.push(
      new Paragraph({
        children: [
          ...
          new TextRun({ text: r.fpp ? `   ·   Fecha probable de parto: ${r.fpp}` : "", size: 20 }),
        ],
      })
    );
    if (r.egFuente)
      children.push(new Paragraph({ children: [new TextRun({ text: r.egFuente, italics: true, size: 16, color: "888888" })] }));
  }
