...
export const ENCABEZADO = {
  titulo: "Consulta Obstétrica Asistida por Ultrasonido",
  lugar: "Liberia, Guanacaste",
};

// Personal médico (editable y ampliable durante la sesión).
export const DEFAULT_MEDICOS = [
  { id: "vga", nombre: "Dr. Vladimir González Araya", especialidades: "Ginecología y Obstetricia · Medicina Fetal · Cardiología Fetal" },
  { id: "kr", nombre: "Dra. Kristel Ramos", especialidades: "" },
  { id: "ke", nombre: "Dra. Karla Espinoza", especialidades: "" },
  { id: "na", nombre: "Dra. Nicole Álvarez", especialidades: "" },
  { id: "bs", nombre: "Dra. Bárbara Salas", especialidades: "" },
  { id: "lv", nombre: "Dr. Luis Villegas", especialidades: "" },
  { id: "lc", nombre: "Dr. Luis Calvo", especialidades: "" },
];
